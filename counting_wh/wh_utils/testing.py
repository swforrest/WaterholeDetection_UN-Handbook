...
def prepare(run_folder, config):
    """
    Given a folder, find all the .tif files from Planet and create a png for each one.
...
def prepare_S2(run_folder, config):
    """
    Given a folder, find all the .tif files from Sentinel and create a png for each one.
    Also rename tif files if required.
